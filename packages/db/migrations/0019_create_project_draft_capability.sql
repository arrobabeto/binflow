INSERT INTO "capability_definitions" (
  ...
  'create_project_draft', 1, '/create_project', 'Create portfolio project',
  'workflow.create_project@1', 'create_project_draft.input@1',
  'create_project_draft.output@1', '["astro_repo"]'::jsonb, 'medium',
